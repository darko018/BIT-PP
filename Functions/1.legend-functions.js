...
// prethodnog definisana callBack funkcija
  function callBack(a) {
    return a;
  }
...
//Constructor - funkcija koja vraća(instancira) objekat(svoju instancu)
  function Cat(name) {
    this.name = name;
  }
  
  
//Instanca - objekat koji je kreirala konstruktorska funkcija je instanca te konstruktor funkcije
